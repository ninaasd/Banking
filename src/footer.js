...
class Footer extends Component {
    ...
    return(
        <footer>
            ...
            <Row>
                <Col>
                <h4 style={{color: "#ffa931"}}>Coded Bank <small style={{fontSize: "15px"}}>Online Banking System</small></h4>
                <ul className="list-unstyled" style={{color: "gray"}}>
                    <li>390 road,</li>
                    <li>four square street,</li>
                    <li>548-432-33 Mumbai</li>
                </ul>
        ...
        <Container fluid>
          &copy; {new Date().getFullYear()} Copyright: <a href="#"> ninaad2001@gmail.com | https://github.com/DeepakMane15</a>
        </Container>
      </div>
